                ...
                <!-- Display Mode -->
                    <div id="displayMode" class="info-grid">
                        <div class="info-field">
                            ...
                            <input type="text" class="field-input" value="2022-00216" readonly>
                    </div>
                        <div class="info-field">
                            <label class="field-label">First Name</label>
                            <input type="text" class="field-input" value="Juan " readonly>
                    </div>
                        <div class="info-field">
                            <label class="field-label">Position</label>
                            <input type="text" class="field-input" value="Stage Manager President" readonly>
                    </div>
                        <div class="info-field">
                            <label class="field-label">Email Address</label>
                            <input type="text" class="field-input" value="jdelacruz00216@usep.edu.ph" readonly>
                    </div>
                        <div class="info-field">
                            <label class="field-label">Last Name</label>
                            <input type="text" class="field-input" value="Dela Cruz" readonly>
                    </div>
                        <div class="info-field">
                            <label class="field-label">Contact Number</label>
                            <input type="text" class="field-input" value="09917952790" readonly>
                    </div>
                </div>
                ...
                <!-- Edit Mode -->
                    ...
                    <form id="updateForm">
                            <div class="info-grid">
                                <div class="info-field">
                                    <label class="field-label">Admin ID</label>
                                    <input type="text" class="field-input" id="updateAdminId" name="admin_id" value="2022-00216" readonly>
                                </div>
                                <div class="info-field">
                                    <label class="field-label">First Name</label>
                                    <input type="text" class="field-input" id="updateFirstname" name="firstname" value="Edryan">
                                </div>
                                <div class="info-field">
                                    <label class="field-label">Position</label>
                                    <input type="text" class="field-input" id="updatePosition" name="position" value="Stage Manager President">
                                </div>
                                <div class="info-field">
                                    <label class="field-label">Email Address</label>
                                    <input type="email" class="field-input" id="updateEmail" name="email" value="esmanocay00216@usep.edu.ph">
                                </div>
                                <div class="info-field">
                                    <label class="field-label">Last Name</label>
                                    <input type="text" class="field-input" id="updateLastname" name="lastname" value="Manocay">
                                </div>
                                <div class="info-field">
                                    <label class="field-label">Contact Number</label>
                                    <input type="tel" class="field-input" id="updatePhone" name="phone" value="09917952790">
                                </div>
                            </div>
                ...
                <div class="card-content">
                    ...
                    <div id="passwordDisplayMode" class="password-display">
                        <div class="password-info">
                            ...
                            <span>Password was last changed 30 days ago</span>
                        </div>
                    </div>
...
function cancelEdit() {
    ...
    document.getElementById('updateFirstname').value = 'Edryan';
    document.getElementById('updateLastname').value = 'Manocay';
    document.getElementById('updatePhone').value = '09917952790';
    document.getElementById('updateEmail').value = 'esmanocay00216@usep.edu.ph';
    document.getElementById('updatePosition').value = 'Stage Manager President';
}
...
function updateProfile() {
    ...
    document.querySelector('#displayMode .info-field:nth-child(1) .field-input').value = document.getElementById('updateAdminId').value;
